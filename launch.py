...
parameter_dict = {	'conv_dHigh'			: 2.7,
					...
					'conv_dLow' 			: -1.9,
					'feedf_dHigh'			: 6.0,
					'feedf_dMid' 			: 0.01, #0.05, 
					'feedf_dNeut' 			: -0.05,
					'feedf_dLow' 			: -1.0, #-2.0,
					'name' 					: 'test_xplor_conv_times3',
					'n_epi_crit' 			: 0,
					'n_epi_dopa' 			: 1,
					'A' 					: 900.,
					'lr_conv' 				: 1e-6,
					...
					'init_file' 			: 'output/pretrain_fsize_9/pretrain_fsize_9', #'output/pretrain_lr_e-6_t_e-0_nolearn_conv', #'output/pretrain_lr_e-6_t_e-0'
					'seed' 					: 954,
					'verbose'		 		: 2
					}
